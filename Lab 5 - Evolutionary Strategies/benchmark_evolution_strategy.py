...
if function == translated_sphere:
    funcname = 'TrSph'
elif function == ackley:
    funcname = 'Ack'
elif function == schaffer2d:
    funcname = 'Sch'
...
plt.savefig('mean_fitness_%s.%s' % (funcname, fig_format), fig_format=fig_format)
plt.figure()
plt.plot(best_ses6)
plt.plot(best_ses12)
plt.plot(best_ses24)
...
plt.savefig('best_fitness_%s.%s' % (funcname, fig_format), fig_format=fig_format)
plt.show()
