...
if classification_function == sum_gt_zero:
    classification_function_name = 'sum_gt_zero.'
elif classification_function == xor:
    classification_function_name = 'xor.'
else:
    classification_function_name = '.'
...
plt.grid()
plt.savefig('cost_function_convergence_' + classification_function_name + fig_format, format=fig_format)
...
plt.ylabel('x2')
plt.title('Dataset')
plt.savefig('dataset_' + classification_function_name + fig_format, format=fig_format)
...
plt.savefig('neural_net_classification_' + classification_function_name + fig_format, format=fig_format)
plt.show()
